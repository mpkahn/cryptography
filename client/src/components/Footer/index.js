  ...
  return (
    ...
    <div className="footer-content">
        ...
        <ul className="socials">
            <li>Omar Dhmash<a href="https://github.com/omartdh"><i className="bx bxl-github"></i></a><a href="https://www.linkedin.com/in/omar-dahmash-b34693a4/"><i className="bx bxl-linkedin"></i></a></li>
